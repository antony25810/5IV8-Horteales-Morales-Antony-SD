...
public class Conecta4 {
    ...
    // tablero
    // las celda (0,0) es la del vortice superior izquierdo)
     ...
     * @param c columna
     * @param j jugador
     * @return Retona -1 si es imposible poner la ficha en la columna indicada. En caso de que se haya introducido
     ...
     * @param c columna
     * @return Retona -1 si es imposible poner la ficha en la columna indicada. En caso de que se haya espacio,
