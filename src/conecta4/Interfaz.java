...
public class Interfaz extends JFrame
{
	...
	public Interfaz()
	{
		super("5IV8 Horteales Morales Antony, Basilio Polo Mario Oswaldo");
...
//Metodos para el manejo de los botones
	...
	public class Reiniciar implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			{
				int respuestaReinicio = JOptionPane.showConfirmDialog(listaMov , " La partida ya ha comenzado,  ¿Deseas reiniciar la partida?", "Nueva partida", JOptionPane.YES_NO_OPTION);
