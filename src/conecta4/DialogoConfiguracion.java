...
public class DialogoConfiguracion extends JDialog{
	...
	public DialogoConfiguracion(JFrame owner){
		...
		JPanel tamano = new JPanel(new GridLayout(2,0));
		JPanel tamano1 = new JPanel(new FlowLayout());
		JPanel tamano2 = new JPanel(new BorderLayout());
		...
		tamano.add(c);
		tamano1.add(tamano);
		tamano2.add(aux, BorderLayout.NORTH);
		tamano2.add(tamano1, BorderLayout.CENTER);
